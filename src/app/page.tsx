    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white font-sans">
      ...
      <section className="py-16 border-t border-white/10 bg-black">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-2xl sm:text-3xl font-black mb-2">Join the Community</h2>
          <p className="text-zinc-400 text-sm mb-10">Follow for hauls, tips & exclusive drops — connect with thousands of resellers</p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            {/* Instagram */}
            <a
              href="https://www.instagram.com/lazzzyvendors"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 bg-gradient-to-r from-purple-600 via-pink-500 to-orange-400 hover:opacity-90 text-white font-black px-7 py-4 rounded-2xl text-base transition-all hover:scale-105 shadow-xl w-full sm:w-auto justify-center"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-left">
                <div className="text-xs opacity-80 font-medium">Follow on Instagram</div>
                <div className="text-base font-black">@lazzzyvendors</div>
              </div>
            </a>
            {/* Discord */}
            <a
              href="https://discord.gg/kK5sU8xzV"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 bg-[#5865F2] hover:bg-[#4752c4] text-white font-black px-7 py-4 rounded-2xl text-base transition-all hover:scale-105 shadow-xl w-full sm:w-auto justify-center"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-left">
                <div className="text-xs opacity-80 font-medium">Join our Discord</div>
                <div className="text-base font-black">LazzzyVendors Server</div>
              </div>
            </a>
          </div>
        </div>
